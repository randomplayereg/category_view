...
public class CategoryAdapter extends RecyclerView.Adapter {
    ...
    public CategoryAdapter(Context pContext, List<Category> pData, RecyclerViewItemClickListener recyclerViewItemClickListener) {
...
//            Toast.makeText(view.getContext(), tmp, Toast.LENGTH_LONG).show();
//
